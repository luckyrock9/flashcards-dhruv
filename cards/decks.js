...
let kard = document.getElementById("kard").textContent = "AL";
let ckard = document.getElementById("ckard").textContent = "Montgomery";
window.alert("works");
let set = document.getElementById("set");
let pair = document.createElement("div");
pair.classList.add("pair");
let card_a = document.createElement("p");
card_a.innerText = states[0]; 
let card_b = document.createElement("p");
card_b.innerText = capitals[0];
